...
public class P2{
    ...
    public synchronized static void receiveMsg(){
        (new Thread(){
            @Override
            public void run(){
    ...
    public synchronized static void sendTo(final int destino, final Message msg){
        (new Thread(){
            @Override
            public void run(){
                String conteudoMsg = null;
    ...
    public synchronized static void treatMsg(final String conteudoMsg){
        (new Thread(){
            @Override
            public void run(){
                String palavraMsg[];
